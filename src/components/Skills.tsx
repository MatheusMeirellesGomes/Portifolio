...
// Exibe as tecnologias organizadas em categorias
...
const Skills = () => {
  ...
  const skillCategories = [
    {
      title: "Linguagens",
      skills: ["Java", "C", "C++", "JavaScript", "TypeScript", "SQL", "C#", "Python"]
    },
    {
      title: "Frontend",
      skills: ["HTML", "CSS", "React", "Next.js", "Vite"]
    },
    {
      title: "Backend & Banco de Dados",
      skills: ["Node.js", "Express", "PostgreSQL", "Prisma ORM", "APIs REST", "Docker"]
    },
    {
      title: "TI & Infraestrutura",
      skills: ["Suporte ao usuário", "Windows", "iOS", "Protheus (ERP)", "Gerenciamento de sistemas"]
    },
    {
      title: "Ferramentas",
      skills: ["Git & GitHub", "VS Code", "IntelliJ", "Prisma Studio"]
    },
    {
      title: "Conceitos",
      skills: ["Algoritmos", "Estruturas de Dados", "POO", "Arquitetura Assíncrona"]
    }
  ];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {skillCategories.map((category, categoryIndex) => (
            ...
            <motion.div
              ...
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: categoryIndex * 0.15 }} // Delay progressivo
              viewport={{ once: true }}
