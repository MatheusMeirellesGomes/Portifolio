  ...
  const features = [
    {
      ...
      description: "Aplicações web com React, TypeScript, Node.js, Express, PostgreSQL e Prisma ORM, do front-end à API"
    },
    {
      icon: <Cpu className="w-8 h-8" />,
      title: "Programação & Algoritmos",
      description: "Lógica de programação, estruturas de dados e POO em Java, C, C++ e Python"
    },
    {
      icon: <Server className="w-8 h-8" />,
      title: "Infraestrutura & Suporte",
      description: "Estagiário de TI na EMATER: infraestrutura, suporte técnico e desenvolvimento em Protheus (ERP)"
    }
  ];
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 mb-12">
            ...
            <div className="text-left max-w-2xl">
              <p className="text-xl text-muted-foreground leading-relaxed mb-4">
                Estudante de <strong className="text-primary">Ciência da Computação na PUC Minas (Lourdes)</strong>,
                cursando o 4º período, e atualmente <strong className="text-primary">estagiário de TI na EMATER</strong>,
                onde atuo com infraestrutura de sistemas, suporte técnico e desenvolvimento backend em Protheus.
              </p>
              <p className="text-lg text-muted-foreground mb-4">
                Combino habilidades de <strong className="text-foreground">desenvolvimento fullstack</strong> — React,
                Node.js, PostgreSQL e Prisma ORM — com capacidade de gerenciar infraestrutura e boa comunicação em equipe.
              </p>
              <p className="text-lg text-primary/90 font-semibold">
                Perfil proativo, analítico e sempre em aprendizado contínuo, buscando evoluir tecnicamente e contribuir
                com soluções reais em equipes de tecnologia.
              </p>
            </div>
          </div>
        </motion.div>
